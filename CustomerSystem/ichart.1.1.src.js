 (function(c) {
  ...
  k = !f && /gecko/.test(a),
  o = /ipod|ipad|iphone|android/gi.test(a),
  l = function(a, b, d, h) {
  return d * a / h + b
  },
  q = {
  easeIn: function(a, b, d, h) {
  return d * (a /= h) * a * a + b
  },
  ...
  if (!c) {
  c = !0;
  for (var a = 0; a < h.length; a++) h[a].call(document);
  h = []
  }
  },
  x = function() {
  ...
  if ("string" === typeof a) return - 1 != a.indexOf("#") && (a = a.substring(1)),
  document.getElementById(a);
  "function" === typeof a && Q(a)
  };
  p.apply = function(a, h) {
  if (a && h && "object" == typeof h) for (var b in h)"undefined" != typeof h[b] && (a[b] = h[b]);
  if (!h && a) {
  var d = {};
  for (b in a) d[b] = a[b];
  return d
  ...
  if (a && p.isObject(h)) for (var b in h) p.isDefined(h[b]) && !p.isDefined(a[b]) && (a[b] = h[b]);
  return ! h && a ? p.apply(a) : a
  };
  p.merge = function(a, h, b) {
  if (a && p.isObject(h)) {
  for (var d in h) p.isDefined(h[d]) && (p.isObject(h[d]) ? p.isObject(a[d]) ? p.merge(a[d], h[d]) : a[d] = p.clone(h[d], !0) : a[d] = h[d]);
  if (p.isObject(b)) return p.merge(a, b)
  }
  return a
  };
  p.clone = function(a, h, b) {
  var d = {};
  if (p.isArray(a) && p.isObject(h)) for (var c = 0; c < a.length; c++) d[a[c]] = b && p.isObject(h[a[c]]) ? p.clone(h[a[c]], b) : h[a[c]];
  else if (p.isObject(a)) for (c in a) d[c] = h && p.isObject(a[c]) && !a[c].ICHARTJS_OBJECT ? p.clone(a[c], h) : a[c];
  return d
  };
  ...
  if (h = /rgba\((\w*),(\w*),(\w*),(.*)\)/.exec(a)) return [h[1], h[2], h[3], h[4]];
  ...
  if (/^#(([a-fA-F0-9]{6,7})|([a-fA-F0-9]{3}))$/.exec(a)) return a = a.replace(/#/g, "").replace(/^(\w)(\w)(\w)$/, "$1$1$2$2$3$3"),
  ...
  p.apply(p, {
          ...
          if (!h[a]) throw Error("Cannot instantiate the type '" + h.type + "'.you must implements it with method '" + a + "'.");
          },
          getAA: function(a) {
          ...
          a = a || 0;
          if (p.isNumber(a)) return [a, a, a, a];
          if (p.isArray(a)) return a;
          h = h || 0;
          ...
          if (a == b) return c > h ? y / 2 : 3 * y / 2;
          if (h == c) return b > a ? 0 : y;
          var d = p.quadrant(a, h, b, c),
          a = n(H((h - c) / (a - b)));
          ...
          var c = p.quadrantd(a),
          d = p.quadrantd(h);
          if ((2 == c || 3 == c) && (2 == d || 3 == d) && h - a < y) return [];
          a = p.toPI2(a);
          h = p.toPI2(h);
          h <= a && (h += A);
          if (a > y) a = A;
          ...
          var h = a.get("id");
          if (!h || "" == h) {
          for (h = p.uid(a.type); C[h];) h = p.uid(a.type);
          a.push("id", h)
          }
          if (C[h]) throw Error("exist reduplicate id :" + h);
          a.id = h;
          C[h] = a
          },
          get: function(a) {
          ...
          if (!p.isNumber(a) && (a = z(a), !p.isNumber(a))) throw Error("[" + h + "]=" + a + "is not a valid number.");
          return a
          },
          ceil: function(a) {
          return L(a, 1)
  ...
  for (var d = c = 0,
       s = h.target; s != document.body && s;) c += s.offsetLeft,
  d += s.offsetTop,
  s = s.offsetParent;
  b.offsetX = b.pageX - c;
  b.offsetY = b.pageY - d
  ...
  for (var c = this.length,
       h, d = 0; d < c && !(h = b ? a.call(b, this[d], d) : a(this[d], d), "boolean" === typeof h && !h); d++);
  return this
  };
  ...
  for (var b = this.length - 1,
       c, h = 0; h < b; h++) for (var d = b; d > h; d--) if (a ? !a(this[d], this[d - 1]) : this[d] < this[d - 1]) c = this[d],
  this[d] = this[d - 1],
  this[d - 1] = c
  };
  c.iChart = m;
  c.$ || (c.$ = c.iChart)
               ...
               for (var f = !0,
                    g = 0; g < e; g++) this.events[b][g].apply(a, c) || (f = !1);
               return f
               },
               on: function(a, b) {
               ...
               push: function(a, b) {
               for (var c = a.split("."), e = c.length - 1, f = this.options, g = 0; g < e; g++) f[c[g]] || (f[c[g]] = {}),
               f = f[c[g]];
               return f[c[e]] = b
               },
               get: function(a) {
               ...
               c.Html = c.extend(c.Element, {
                                 ...
                                 css: function(a, b) {
                                 if (c.isString(a)) if (c.isDefined(b)) this.dom.style[a] = b;
                                 else return this.dom.style[a]
                                 },
                                 applyStyle: function() {
                                 for (var a = this.get("style").split(";"), b, c = 0; c < a.length; c++) b = a[c].split(":"),
                                 1 < b.length && this.css(b[0], b[1])
                                 }
                                 });
               ...
               c.Tip = c.extend(c.Html, {
                                ...
                                if ("follow" == a.get("showType")) a.T.on("mousemove",
                                                                          function(b, c, e) {
               ...
               c.Legend = c.extend(c.Component, {
                                   ...
                                   var i = g.get("sign_size"),
                                   j = g.getPlugin("sign");
                                   if (!j || !j.call(g, g.T, f, a + i / 2, b, i, e)) - 1 != f.indexOf("bar") && g.T.box(a, b - i / 12, i, i / 6, 0, e),
                                   "round" == f ? g.T.round(a + i / 2, b, i / 2, e) : "round-bar" == f ? g.T.round(a + i / 2, b, i / 4, e) : "square-bar" == f ? g.T.box(a + i / 4, b - i / 4, i / 2, i / 2, 0, e) : "square" == f && g.T.box(a, b - i / 2, i, i, 0, e);
                                   ...
                                   for (var o = 0; o < i; o++) {
                                   for (var g = 0,
                                        l = o; l < k; l += i) g = Math.max(g, a.data[l].width_);
                                   a.columnwidth[o] = g;
                                   e += g
                                   }
                                   for (o = 0; o < j; o++) {
                                   g = 0;
                                   for (l = o * i; l < k; l++) g = Math.max(g, a.data[l].text.split("\n").length);
                                   a.columnheight[o] = g;
                                   f += g
                                   }
                                   e = a.push(a.W, e + a.get("hpadding") + a.get("signwidth") * i + (i - 1) * a.get("legend_space"));
                                   if (e > a.get("maxwidth")) i = a.get("maxwidth") / e,
                                   j = c.lowTo,
                                   k = Math.floor,
                                   a.push("fontsize", j(6, k(a.get("fontsize") * i))),
                                   a.push("sign_size", j(6, k(d * i))),
                                   a.push("sign_space", j(4, k(a.get("sign_space") * i))),
                                   a.push("legend_space", j(4, k(a.get("legend_space") * i))),
                                   a.push("fontStyle", c.getFont(a.get("fontweight"), a.get("fontsize"), a.get("font"))),
                                   a.doLayout(a, b);
                                   else {
                                   var q;
                                   ...
                                   g += q;
                                   for (l = 0; l < i && o * i + l < k; l++) e = a.data[o * i + l],
                                   e.y = g,
                                   e.x = f,
                                   f += a.columnwidth[l] + d;
                                   g += q
                                   ...
                                   var a = this._(),
                                   b = a.root,
                                   d = c.isNumber(a.get("column")),
                                   e = c.isNumber(a.get("row")),
                                   f = a.data.length;
                                   ...
                                   a.data.each(function(b, d) {
                                               ...
                                               a); ! d && !e && (d = a.push("column", 1));
                                   d && !e && (e = a.push("row", Math.ceil(f / a.get("column")))); ! d && e && (d = a.push("column", Math.ceil(f / a.get("row"))));
                                   d = a.get("column");
                                   e = a.get("row");
               ...
               c.Text = c.extend(c.Component, {
                                 ...
                                 a.applyGradient()
                                      ...
                                      if (!h || !h.tagName || "canvas" != h.tagName.toLowerCase()) throw Error("there not a canvas element");
                                      this.canvas = h;
...
//                                      var ratio = 2;
                                      ...
                                      j = b.get("labels");
                                      b.data = h;
                                      if ("simple" == b.dataType) b.total = 0,
                                      h.each(function(h) {
                                             ...
                                             for (var i = 0; i < d.length; i++) d[i] = t(d[i]),
                                             j += d[i],
                                             g || (c = e = d[i], g = !0),
                                             c = k(d[i], c),
                                             e = o(d[i], e);
                                             ...
                                             b),
                                      a.isArray(j) && (f = j.length > f ? j.length: f),
                                      b.push("maxItemSize", f);
                                      else if ("stacked" == b.dataType || "complex" == b.dataType) {
                                      var i = j.length,
                                      n, m, l, r = "stacked" == b.dataType;
                                      if (0 == i) for (var i = h[0].value.length, q = 0; q < i; q++) j.push("");
                                      b.columns = [];
                                      for (q = 0; q < i; q++) n = [],
                                      m = 0,
                                      h.each(function(a, b) {
                                             if (d = a.value[q]) a.value[q] = d = t(d, d),
                                             m += d,
                                             r ? l = h[b].color: (l = a.color, g || (c = e = d, g = !0), c = k(d, c), e = o(d, e)),
                                             n.push({
                                                    name: a.name,
                                                    value: a.value[q],
                                                    background_color: l,
                                      ...
                                      css: function(h, b) {
                                      if (a.isDefined(b)) this.canvas.style[h] = b;
                                      else return this.canvas.style[h]
                                      },
                                      ...
                                      for (t && this.moveTo(a, b); f <= g;) this.lineTo(a + c * q(f), b + d * l(f)),
                                      f += e;
                                      ...
                                      v = s;
                                      for (this.fillStyle(a.dark(i)).moveTo(h + c * q(s), b + d * l(s)).beginPath(); v <= f;) g.call(this, v),
                                      v += e;
                                      g.call(this, f);
                                      this.lineTo(h + c * q(f), b + j + d * l(f));
                                      for (v = f; v >= s;) g.call(this, v, j),
                                      v -= e;
                                      g.call(this, s, j);
                                      ...
                                      var w = a.quadrantd(f),
                                      k = a.quadrantd(g),
                                      v = a.dark(v); (1 == w || 2 == w) && b.call(this, h, c, d, e, j, i, f, v); (0 == k || 3 == k) && b.call(this, h, c, d, e, j, i, g, v)
                                      },
                                      ...
                                      this.polygon(a.dark(i), k, n, l, !1, !1, [{
                                                                                x: b,
                                                                                y: c
                                                                                },
                                                                                {
                                      ...
                                      for (; 6 > o.length;) o.push(!1);
                                      d = m(n, d);
                                      e = m(n, e);
                                      i = [];
                                      0 > e ? a.isObject(o[4]) && i.push(a.applyIf({
                                                                                   points: [{
                                                                                            x: b,
                                                                                            y: c - j
                                                                                            },
                                                                                   ...
                                                                                   o[4])) : a.isObject(o[0]) && i.push(a.applyIf({
                                                                                                                                 points: [{
                                                                                                                                          x: b,
                                                                                                                                          y: c
                                                                                                                                          },
                                                                                                                                 ...
                                                                                                                                 o[0]));
                                      a.isObject(o[1]) && i.push(a.applyIf({
                                                                           points: [{
                                                                                    x: d,
                                                                                    y: e
                                                                                    },
                                                                           ...
                                                                           o[1]));
                                      a.isObject(o[2]) && i.push(a.applyIf({
                                                                           points: [{
                                                                                    x: b,
                                                                                    y: c
                                                                                    },
                                                                           ...
                                                                           o[2]));
                                      a.isObject(o[3]) && i.push(a.applyIf({
                                                                           points: [{
                                                                                    x: b + g,
                                                                                    y: c
                                                                                    },
                                                                           ...
                                                                           o[3]));
                                      0 > e ? a.isObject(o[0]) && i.push(a.applyIf({
                                                                                   points: [{
                                                                                            x: b,
                                                                                            y: c
                                                                                            },
                                                                                   ...
                                                                                   o[0])) : a.isObject(o[4]) && i.push(a.applyIf({
                                                                                                                                 points: [{
                                                                                                                                          x: b,
                                                                                                                                          y: c - j
                                                                                                                                          },
                                                                                                                                 ...
                                                                                                                                 o[4]));
                                      a.isObject(o[5]) && i.push(a.applyIf({
                                                                           points: [{
                                                                                    x: b,
                                                                                    y: c
                                                                                    },
                                      ...
                                      for (d = 1; d < g.length; d++) this.bezierCurveTo(r(g, g[d], d, i));
                                      this.lineTo(m(c, k[1].x), m(c, k[1].y))
                                      } else for (d = 1; d < g.length; d++) this.lineTo(m(c, g[d].x), m(c, g[d].y));
                                      ...
                                      for (c = 2; c < a.length - 1; c += 2) this.lineTo(m(b, a[c]), m(b, a[c + 1]));
                                      ...
                                      for (c = 1; c < a.length; c++) d ? this.bezierCurveTo(r(a, a[c], c, e || 1.5)) : this.lineTo(m(b, a[c].x), m(b, a[c].y));
                                      return this.stroke(!0).restore()
                                      },
                                      ...
                                      d = m(f, d),
                                      e = m(f, e),
                                      n = a.distanceP2P(b, c, d, e),
                                      o;
                                      if (0 >= j || n <= j || b != d && c != e) return this.line(b, c, d, e, f, g, l);
                                      if (b > d || c > e) o = b,
                                      b = d,
                                      d = o,
                                      o = c,
                                      ...
                                      k = c == e;
                                      g = n ? g + 1 : g;
                                      for (l = 1; l <= g; l++) this.lineTo(k ? b + j * l + f * (l - 1) : b, k ? c: c + j * l + f * (l - 1)).moveTo(k ? b + (j + f) * l: b, k ? c: c + (j + f) * l);
                                      n || this.lineTo(d, e);
                                      return this.stroke(!0).restore()
                                      },
...
//                                      this.c.fillRect(a, b, c*pixelTatio, d*pixelTatio);
                                      ...
                                      a.Chart = a.extend(a.Painter, {
                                                         ...
                                                         b.redraw = !0; ! b.Animationed && b.get("animation") ? b.runAnimation(b) : (b.segmentRect(), b.components.eachAll(function(a) {
                                                                                                                                                                           a.draw(c)
                                                                                                                                                                           }), b.resetCanvas())
                                                         },
                                                         plugin: function(a) {
...
//                                                         a.shell.width = a.width * pixelTatio;
//                                                         a.shell.height = a.height * pixelTatio;
                                                         },
                                                         initialize: function() {
                                                         var b = this._(),
                                                         c = b.get("data"),
                                                         ...
                                                         b.Rendered && !b.initialization && (c && 0 < c.length ? u.call(b, c, b) : a.isString(b.get("url")) && b.ajax.call(b, b.get("url"),
                                                                                                                                                                           function(a) {
                                                                                                                                                                           b.push("data", a);
                                                                                                                                                                           b.initialize();
                                                                                                                                                                           b.draw()
                                                         ...
                                                         d = b.Combination,
                                                         e = !b.get("turn_off_touchmove") && !d,
                                                         f = !a.touch && b.get("default_mouseover_css") && !d,
                                                         g,
                                                         ...
                                                         b.on(j[0],
                                                              ...
                                                              a.components.eachAll(function(a) {
                                                                                   if (a.ICHARTJS_CHART) {
                                                                                   if (a.fireEvent(a, j[0], [a, b])) return c.click = !0,
                                                                                   !1
                                                                                   } else {
                                                                                   var d = a.isMouseOver(b);
                                                                                   if (d.valid) return c.click = !0,
                                                                                   a.fireEvent(a, "click", [a, b, d]),
                                                                                   !b.stopPropagation
                                                                                   }
                                                                                   });
                                                              if (c.click) return e && b.event.preventDefault(),
                                                              c.click = !1,
                                                              !0
                                                              });
                                                         if (!a.touch || e) if (b.on(j[1],
                                                                                     function(a, b) {
                                                                                     g = !1;
                                                                                     a.components.eachAll(function(a) {
                                                                                                          if (a.ICHARTJS_CHART) {
                                                                                                          if (a.fireEvent(a, j[1], [a, b])) return g = !0,
                                                                                                          !1
                                                                                                          } else {
                                                                                                          var c = a.variable.event,
                                                                                                          d = a.isMouseOver(b);
                                                                                                          if (d.valid) {
                                                                                                          if (g = g || a.atomic, c.mouseover || (c.mouseover = !0, a.fireEvent(a, "mouseover", [a, b, d])), a.fireEvent(a, "mousemove", [a, b, d]), d.stop) return ! 1
                                                                                                          } else c.mouseover && (c.mouseover = !1, a.fireEvent(a, "mouseout", [a, b, d]));
                                                                                                          return ! b.stopPropagation
                                                                                                          }
                                                                                                          });
                                                                                     if (c.mouseover) return b.event.preventDefault(),
                                                                                     !g && c.mouseover && (c.mouseover = !1, a.fireEvent(a, "mouseout", [a, b])),
                                                                                     c.mouseover;
                                                         ...
                                                         var e = !!b.get("communal_acting"),
                                                         g = b.getPercent(c.value, c.total);
                                                         ...
                                                         f = b.push("client_width", b.width - b.get("hpadding"));
                                                         ...
                                                         a.isString(b.get("footnote")) && b.push("footnote", a.applyIf({
                                                                                                                       ...
                                                                                                                       b.default_.footnote));
                                                         if ("" != b.get("title.text")) {
                                                         var j = "" != b.get("subtitle.text"),
                                                         c = j ? b.get("title.height") + b.get("subtitle.height") : b.get("title.height"),
               ...
               c.Scale = c.extend(c.Component, {
                                  ...
                                  if (!c.isNumber(i) || i < f) i = c.ceil(f),
                                  i = a.push("end_scale", !i && !j ? 1 : i);
                                  ...
                                  var k, o, l, q = f = e = b = i = 0,
                                  m = 0;
                                  k = a.get("scale_width");
                                  o = k / 2;
                                  l = a.get("scaleAlign");
                                  var r = a.get("position"),
                                  t = a.get("text_space"),
                                  u = "",
                                  h = a.get("coo").get("axis.width");
                                  ...
                                  for (t = 0; t <= a.number; t++) k = d ? a.get("labels")[t] : (g * t + j).toFixed(a.get("decimalsnum")),
                                  o = a.isH ? a.get("valid_x") + t * a.get("distanceOne") : a.x,
                                  l = a.isH ? a.y: a.get("valid_y") + a.get("distance") - t * a.get("distanceOne"),
                                  a.items.push({
                                               x: o,
                                               y: l,
                                               x0: o + e,
                                  ...
                                  a.get("label") && a.labels.push(new c.Text(c.applyIf(c.apply(a.get("label"), c.merge({
                                                                                                                       ...
                                                                                                                       a.fireEvent(a, "parseText", [k, o + q, l + m, t, a.number == t]))), {
                                                                                       textAlign: r,
                                                                                       textBaseline: u
                                                                                       }), a))
                                  }
               ...
               var b = this._(),
               d = b.get("coordinate");
               if (d.ICHARTJS_OBJECT) return b.ILLUSIVE_COO = !0,
               d;
               var d = c.parsePercent,
               e = b.get("coordinate.scale"),
               f = b.get("scaleAlign"),
               g = b.push("coordinate.width", d(b.get("coordinate.width"), Math.floor(0.84 * b.get("client_width")))),
               i = b.push("coordinate.height", d(b.get("coordinate.height"), Math.floor(0.84 * b.get("client_height"))) - (b.is3D() ? (b.get("coordinate.pedestal_height") || 22) + (b.get("coordinate.board_deep") || 20) : 0));
               ...
               c.Coordinate2D = c.extend(c.Component, {
                                         ...
                                         a.doCrosshair(a);
                                         var d, e = (b = !(!a.get("gridlinesVisible") || !a.get("grids"))) && !!a.get("grids.horizontal"),
                                         f = b && !!a.get("grids.vertical"),
                                         g = a.get(a.H),
                                         i = a.get(a.W),
                                         j = a.get("valid_width"),
                                         k = a.get("valid_height"),
                                         ...
                                         u = c.applyIf(a.get("gridHStyle"), t),
                                         h = c.applyIf(a.get("gridVStyle"), t);
                                         if (b) {
                                         var s, v, w;
                                         a.scale.each(function(b) {
                                                      w = b.get("position");
                                                      if (!c.isFalse(b.get("scale2grid")) && !(e && "v" == b.get("which") || f && "h" == b.get("which"))) s = v = 0,
                                                      w == a.O ? v = g: w == a.R ? s = -i: w == a.B ? v = -g: s = i,
                                                      b.items.each(function(d) {
                                                                   m && a.gridlines.push(c.applyIf({
                                                                                                   overlap: r.call(a, b.get("which"), d.x, d.y),
                                                                                                   x1: d.x,
                                                                                                   y1: d.y,
                                                                                                   x2: d.x + s,
                                                                                                   y2: d.y + v
                                         ...
                                         for (x = 0; x <= t; x++) m && a.gridlines.push(c.applyIf({
                                                                                                  overlap: r.call(a, "h", a.x + x * b, a.y),
                                                                                                  x1: a.x + x * b,
                                                                                                  y1: a.y,
                                                                                                  x2: a.x + x * b,
                                                                                                  y2: a.y + g,
                                         ...
                                         for (x = 0; x <= t; x++) m && a.gridlines.push(c.applyIf({
                                                                                                  overlap: r.call(a, "v", a.x, a.y + x * b),
                                                                                                  x1: a.x,
                                                                                                  y1: a.y + x * b,
                                                                                                  x2: a.x + i,
                                                                                                  y2: a.y + x * b,
               ...
               c.Coordinate3D = c.extend(c.Coordinate2D, {
                                         ...
                                         for (var a = this._(), b = a.get("wall_style"), d = a.get("background_color") || "#d6dbd2", e = a.get(a.H), f = a.get(a.W), g = a.get("color_factor"), i = a.push("z_offx", a.get("xAngle_") * a.get("zHeight")), j = a.push("z_offy", a.get("yAngle_") * a.get("zHeight")); 6 > b.length;) b.push({
                                                                                                                                                                                                                                                                                                                                            color: d
                                                                                                                                                                                                                                                                                                                                            });
               ...
               c.Sector2D = c.extend(c.Sector, {
                                     ...
                                     isEventValid: function(a, b) {
                                     if (!b.get("ignored")) {
                                     if (b.isLabel() && b.label.isEventValid(a, b.label).valid) return {
                                     valid: !0
                                     };
                                     var d = c.distanceP2P(b.x, b.y, a.x, a.y),
                                     e = b.get("donutwidth");
                                     if (b.r < d || e && b.r - e > d) return {
                                     valid: !1
                                     };
                                     if (c.angleInRange(b.get("startAngle"), b.get("endAngle"), c.atan2Radian(b.x, b.y, a.x, a.y))) return {
                                     valid: !0
                                     }
                                     }
                                     return {
                                     ...
                                     d *= 2;
                                     if (a.get("label")) if (a.get("mini_label")) P2 = c.p2Point(a.x, a.y, b, a.get("donutwidth") ? a.r - a.get("donutwidth") / 2 : a.r / 2),
                                     a.doText(a, P2.x, P2.y);
                                     else {
                                     var e = c.quadrantd(b),
               ...
               c.Sector3D = c.extend(c.Sector, {
                                     ...
                                     if (!c.inEllipse(a.x - b.x, a.y - b.y, b.a, b.b)) return {
                                     valid: !1
                                     };
                                     if (c.angleZInRange(b.sA, b.eA, c.atan2Radian(b.x, b.y, a.x, a.y))) return {
                                     valid: !0
                                     }
                                     }
                                     return {
                                     ...
                                     g *= 2;
                                     if (a.get("label")) if (a.get("mini_label")) g = a.p2p(a.x, a.y, d, 0.5),
                                     a.doText(a, g.x, g.y);
                                     else {
                                     var f = c.quadrantd(d),
                                     i = a.p2p(a.x, a.y, d, g / a.a + 1),
                                     j = a.p2p(a.x, a.y, d, 0.6 * g / a.a + 1),
                                     d = a.p2p(a.x, a.y, d, 1);
               ...
               c.Pie = c.extend(c.Chart, {
                                ...
                                if (a.is3D() ? c.inEllipse(a.get(a.X) - b, a.topY - d, a.a, a.b) : c.distanceP2P(a.get(a.X), a.topY, b, d) < a.r) d = a.topY - d,
                                e.push("labelx", a.get(a.X) + (2 * Math.sqrt(a.r * a.r - d * d) + f) * (0 == g || 3 == g ? 1 : -1)),
                                e.localizer(e)
                                },
                                localizer: function(a) {
                                ...
                                b.each(function(b) {
                                       c.each(function(c) {
                                              g = c.labelx;
                                              i = c.labely;
                                              if (b.labely <= i && i - b.labely - 1 < b.get(a.H) || b.labely > i && b.labely - i - 1 < c.get(a.H)) if (b.labelx < g && g - b.labelx < b.get(a.W) || b.labelx > g && b.labelx - g < c.get(a.W)) f = b.get("quadrantd"),
                                              b.push("labely", b.get("labely") + i - b.labely + (b.get(a.H) + e) * (1 < f ? -1 : 1)),
                                              b.localizer(b),
                                              a.dolayout(a, b.get("labelx"), b.get("labely") + b.get(a.H) / 2 * (2 > f ? -1 : 1), b, e, f)
                                              },
                                              a);
                                       c.push(b)
                                       })
               ...
               c.Pie3D = c.extend(c.Pie, {
                                  ...
                                  one: function(a) {
                                  var b, d, e = [],
                                  f = a.get("counterclockwise"),
                                  g = function(a, b) {
                                  return 1 + Math.sin(b ? a + Math.PI: a)
                                  },
                                  i;
                                  lay = function(a, d, e, f) {
                                  i = c.quadrantd(d); (a && (0 == i || 3 == i) || !a && (2 == i || 1 == i)) && b.push({
                                                                                                                      g: d,
                                                                                                                      z: d == e,
                                                                                                                      x: f.x,
                                                                                                                      y: f.y,
                                  ...
                                  var a = this._(),
                                  b = c.angle2Radian(a.get("zRotate"));
               ...
               c.Column = c.extend(c.Chart, {
                                   ...
                                   engine: function(a) {
                                   var b = a.get("column_width"),
                                   c = a.get("column_space"),
                                   e = a.coo.getScale(a.get("scaleAlign")),
                                   f = a.coo.get(a.H),
                                   g = b / 2,
                                   i = b * (a.get("group_fator") || 0),
                                   j = "complex" != a.dataType ? b + c: a.data.length * b + c + (a.is3D() ? (a.data.length - 1) * i: 0),
                                   k = a.coo.get(a.Y) + f,
                                   o = k - e.basic * f - (a.is3D() ? a.get("zHeight") * (a.get("bottom_scale") - 1) / 2 * a.get("yAngle_") : 0),
                                   l = c + a.coo.get("x_start"),
                                   k = k + a.get("text_space") + a.coo.get("axis.width")[2];
                                   ...
                                   a.coo = c.Coordinate.coordinate_.call(a,
                                                                         function() {
                                                                         var b = a.data.length,
                                                                         c = a.get("coordinate.valid_width"),
                                                                         e,
                                                                         f,
                                                                         g;
               ...
               c.Bar = c.extend(c.Chart, {
                                ...
                                engine: function(a) {
                                var b = a.get("bar_height"),
                                c = a.get("bar_space"),
                                e = a.coo.getScale(a.get("scaleAlign")),
                                f = a.coo.get(a.W),
                                g = b / 2,
                                i = "complex" != a.dataType ? b + c: a.data.length * b + c,
                                j = a.coo.get(a.X) + e.basic * f,
                                k = a.coo.get(a.X) - a.get("text_space") - a.coo.get("axis.width")[3],
                                o = a.coo.get("y_start") + c;
               ...
               c.LineSegment = c.extend(c.Component, {
                                        ...
                                        var j = i.left,
                                        i = i.top,
                                        j = 3 > e.tipPosition && 0 < j - f - a - b || 2 < e.tipPosition && 0 > j - f - a - b ? j - (f + b) : j + b,
                                        ...
                                        a.labels = [];
                                        var b = a.get("points"),
                                        d = a.get("intersection"),
                                        e = !!a.get("label"),
                                        f = [],
                                        g = !1,
                                        i = a.get("smooth"),
                                        j = a.get("smoothing") || 1.5,
                                        k = a.get("f_color"),
                                        o = a.get("brushsize"),
                                        l = a.get("point_size");
                                        if (d) {
                                        var q = a.getPlugin("sign"),
                                        m = k,
                                        r = a.get("hollow_color");
                                        ...
                                        b.each(function(b) {
                                               b.x_ = b.x;
                                               b.y_ = b.y; ! b.ignored && e && (a.push("label.originx", b.x), a.push("label.originy", b.y - l / 2 - 1), a.push("label.text", a.fireString(a, "parseText", [a, b.value], b.value)), c.applyIf(a.get("label"), {
                                                                                                                                                                                                                                             textBaseline: "bottom",
                                                                                                                                                                                                                                             color: a.get("f_color")
                                        ...
                                        var a = this._(),
                                        b = 3 * a.get("point_size") / 2,
                                        d = a.get("point_space"),
                                        e = a.get("event_range_y"),
                                        f = a.get("event_range_x"),
                                        g = a.get("tipInvokeHeap"),
                                        i = a.get("points"),
                                        j = a.get("name");
                                        a.parse(a);
                                        if (0 >= f || f > d / 2) f = a.push("event_range_x", d / 2);
                                        0 == e && (e = a.push("event_range_y", b / 2));
                                        a.get("tip.enable") && (a.on("mouseover",
                                                                     function() {
                                                                     g.push(a);
                                        ...
                                        var k = a.get("coordinate"),
                                        o = a.get("limit_y"),
                                        l = a.get("keep_with_coordinate"),
                                        q = function(a, b, c) {
                                        ...
                                        if (k && !k.isEventValid(b, k).valid) return {
                                        valid: false
                                        };
                                        var e = Math.floor((b.x - a.x) / d);
                                        if (e < 0 || e >= i.length - 1) {
                                        e = c.between(0, i.length - 1, e);
                                        return q(i[e], b.x, b.y) ? m(e) : {
                                        valid: l
                                        }
                                        }
                                        for (var f = e; f <= e + 1; f++) if (q(i[f], b.x, b.y)) return m(f);
                                        return {
                                        valid: l
                                        }
                                        }
               ...
               c.Line = c.extend(c.Chart, {
                                 ...
                                 a.get("crosshair.enable") && (a.push("crosshair.hcross", b), a.push("crosshair.invokeOffset",
                                                                                                     function(b) {
                                 ...
                                 var b = a.coo.get("valid_width"),
                                 e = a.coo.get("valid_height"),
                                 f = b / (a.get("maxItemSize") - 1),
                                 g = a.get("point_space");
                                 ...
                                 var i, j = a.coo.get(a.X),
                                 k = a.coo.get(a.Y),
                                 o = a.coo.get(a.H),
                                 l = a.get("tipMockerOffset"),
                                 q,
                                 m,
                                 r,
                                 l = c.isNumber(l) ? 0 > l ? 0 : 1 < l ? 1 : l: null;
                                 a.push("tip.invokeOffset",
                                        function(a, b, c) {
                                        if (l != null) c.top = k + (o - b) * l;
                                        else {
                                        c.top = c.maxTop - (c.maxTop - c.minTop) / 3 - b;
                                        if (b > o || k > c.top) c.top = k
                                        }
                                        return {
                                        left: c.left - a - j > 5 ? c.left - a - 5 : c.left + 5,
                                        top: c.top
                                        }
                                        });
                                 ...
                                 b = new c.Custom({
                                                  ...
                                                  a.lines.each(function(a, c) {
                                                               r = a.isEventValid(b);
                                                               if (c == 0) m.minTop = m.maxTop = r.top;
                                                               else {
